				...
				<div id="nav" >
					...
					if (rs1.next()){
						...
						<div class="wall-of-buttons">
							<P><a class="large blue button" href="Following.jsp?userID=<%out.print(rs1.getString("user_id"));%>">我的关注</a></P>
         			<P><a class="large green button" href="Follower.jsp?userID=<%out.print(rs1.getString("user_id"));%>">我的粉丝</a></P>
						 <br>
			</div>
				</div>
				<div id="section">
